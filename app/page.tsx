    ...
    <main className="flex min-h-screen flex-col">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-indigo-50 via-purple-50 to-slate-50 dark:from-indigo-950/30 dark:via-purple-950/20 dark:to-slate-950">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-16 pt-12 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-600 dark:text-slate-400">
            Purpose-built tooling for engineering teams, and personal apps for
            everyone else.
          </p>
        </div>
      </div>
      ...
      <section className="bg-white py-14 dark:bg-slate-950">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-orange-100 px-3 py-1 text-sm font-medium text-orange-800 dark:bg-orange-900/50 dark:text-orange-300">
            Personal Apps
          </div>
          ...
          <p className="mt-4 max-w-2xl text-lg text-slate-600 dark:text-slate-400">
            Small software you build for yourself, without setting up a project for
            each idea.
          </p>
          ...
          <div className="mt-8 grid gap-6">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-900">
              <div className="grid lg:grid-cols-2">
                <div className="p-8">
                  <div className="mb-4 inline-flex h-12 w-12 items-center justify-center overflow-hidden rounded-lg">
                    <img
                  ...
                  <p className="mt-2 text-slate-600 dark:text-slate-400">
                    A home for your personal apps. Describe what would help — a meal
                    planner, a reading list, a project tracker — and AI builds it.
                    Each app has an assistant that remembers you, and they all live
                  ...
                  <ul className="mt-4 space-y-2 text-sm text-slate-600 dark:text-slate-400">
                    <li className="flex items-center gap-2">
                      ...
                      Built from a plain-language prompt, typed or spoken
                    </li>
                    <li className="flex items-center gap-2">
                      <svg className="h-4 w-4 shrink-0 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      An assistant per app that remembers you
                    </li>
                    <li className="flex items-center gap-2">
                      <svg className="h-4 w-4 shrink-0 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      Automatic routines that run on a schedule you set
                    </li>
                  </ul>
                ...
                <div className="relative flex items-center justify-center bg-slate-100 p-8 dark:bg-slate-800/50">
                  <img
      ...
      <section className="bg-slate-50 py-14 dark:bg-slate-900">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="mt-4 max-w-2xl text-lg text-slate-600 dark:text-slate-400">
            Extend Atlassian Compass with powerful visualization tools.
          </p>
