...
export const metadata: Metadata = {
  title: 'MCPflare - Zero-Trust MCP Security',
  description:
    'Use local MCP servers securely with zero-trust isolation while reducing context window token usage by up to 98%.',
};

export default function MCPflarePage() {
  return (
    <main className="flex min-h-screen flex-col">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-br from-green-50 via-emerald-50 to-slate-50 dark:from-green-950/30 dark:via-emerald-950/20 dark:to-slate-950">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-16 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-600 dark:text-slate-400">
            Use local MCP servers securely with zero-trust isolation while reducing
            context window token usage by up to{' '}
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="relative rounded-2xl border border-slate-200 bg-slate-50 p-8 dark:border-slate-800 dark:bg-slate-900">
              ...
              <p className="mt-2 text-slate-600 dark:text-slate-400">
                Complete process isolation using Cloudflare Workers. Each execution
                runs in a fresh, disposable environment.
              </p>
            </div>
            ...
            <div className="relative rounded-2xl border border-slate-200 bg-slate-50 p-8 dark:border-slate-800 dark:bg-slate-900">
              ...
              <p className="mt-2 text-slate-600 dark:text-slate-400">
                Zero outbound network access. Code cannot exfiltrate data or make
            ...
            <div className="relative rounded-2xl border border-slate-200 bg-slate-50 p-8 dark:border-slate-800 dark:bg-slate-900">
              ...
              <p className="mt-2 text-slate-600 dark:text-slate-400">
                Pre-execution security checks block dangerous patterns like eval(),
            ...
            <div className="relative rounded-2xl border border-slate-200 bg-slate-50 p-8 dark:border-slate-800 dark:bg-slate-900">
              ...
              <p className="mt-2 text-slate-600 dark:text-slate-400">
                All MCP tool calls automatically route through secure isolation. No
                config changes needed for existing MCPs.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-green-600 py-16 dark:bg-green-900">
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <p className="mt-4 text-lg text-green-100">
            Get started with the VS Code extension or read the documentation.
          </p>
