...
description: Learn how to add, edit, and manage technology items in your Tech Radar.
---
...
<img src="/images/tech-radar/admin-page.png" alt="Tech Radar Items List" className="w-full rounded-lg shadow-lg my-4" />
...
<img src="/images/tech-radar/add-radar-item.png" alt="Add New Tech Radar Item Form" className="w-full rounded-lg shadow-lg my-4" />
...
1. [Customize the radar's appearance](/tech-radar/docs/admin-guide/customization)
2. [Configure data management](/tech-radar/docs/admin-guide/data-management)
