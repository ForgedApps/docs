...
description: Learn how to understand and interpret technology items on the radar.
---
...
<img src="/images/tech-radar/blip-shapes.png" alt="Blip Shapes" className="w-full rounded-lg shadow-lg my-4" />
