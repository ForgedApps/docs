...
description: Learn how to filter and search for specific technologies in the Tech Radar.
---
...
<img src="/images/tech-radar/search-page.png" alt="Search Page" className="w-full rounded-lg shadow-lg my-4" />
